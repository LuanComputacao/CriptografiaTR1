...
public class HashGeneratorUtils {
     ...
     */
    public static String fileGenerateMD5(File file) throws HashGenerationException {
     ...
     * @throws HashGenerationException
     */
    public static String fileGenerateSHA1(File file) throws HashGenerationException {
     ...
     * @throws HashGenerationException
     */
    public static String fileGenerateSHA256(File file) throws HashGenerationException {
